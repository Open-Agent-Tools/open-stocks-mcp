...
- **Current Version**: v0.6.3 with account details fix and 80 MCP tools
...
### Next Phase Priority
**Phase 8: Quality & Reliability (v0.6.3)** - Final phase:
...
### Common API Bugs Fixed in v0.5.7-v0.6.3
...
- **Account details parsing**: Parse load_phoenix_account results[0] and extract currency amounts
